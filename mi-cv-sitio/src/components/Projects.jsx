      ...
      <Card sx={{ bgcolor: 'background.paper', border: '1px solid #334155' }}>
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary" paragraph>
            Diseño y construcción de una arquitectura distribuida de alto rendimiento utilizando .NET 10 y C#. 
            Implementación de patrones Event Sourcing con MongoDB como Event Store y CQRS. Garantía de consistencia 
            atómica mediante el patrón Transactional Outbox y Apache Kafka como Message Broker.
          </Typography>
          
          <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap sx={{ mt: 2 }}>
            {['.NET 10', 'C#', 'Kafka', 'MongoDB', 'CQRS', 'React'].map((tech) => (
