...
const jobs = [
  {
    ...
    description:
      "Liderazgo técnico del ecosistema de Onboarding B2B y Broxel Comercios. Diseño y evolución de arquitectura distribuida utilizando patrones CQRS y Event-Driven, asegurando alta disponibilidad e integridad financiera.",
    achievements:
      "Entrega de plataformas operativas en 6 meses, optimizando costos de infraestructura en la nube.",
  ...
  },
  {
    ...
    description:
      "Responsable del desarrollo y mantenimiento de los portales de monitoreo del core del sistema SPEI y SPID Azteca para la detección oportuna de incidentes operativos.",
  ...
  },
  {
    ...
    icon: <TerminalIcon />,
    description:
      "Desarrollo de software web (Zeit Compact) y aplicaciones móviles enfocadas en control de acceso por proximidad y control horario.",
    achievements:
      "Lanzamiento en tiempo y forma de dos aplicaciones móviles, logrando adjudicar contrato con BBVA.",
    ...
    <Box id="experience" component="section">
      ...
      <Timeline position="right" sx={{ p: 0 }}>
        {jobs.map((job, index) => (
          <TimelineItem
            key={index}
            sx={{ "&::before": { display: { xs: "none", md: "block" } } }}
          >
            <TimelineSeparator>
              <TimelineDot
                variant="outlined"
